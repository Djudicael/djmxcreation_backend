...
export class Router extends TemplateRenderer {
    ...
    constructor() {
        ...
        this.routes = [
            ...
            {
                name: 'p-home',
                path: '../pages/home.component.js',
                regExp: new RegExp(/^#\/$/)
            },
            // Sign in/Sign up pages (URL: /#/login, /#/register )
            {
                name: 'p-about',
                path: '../pages/about.component.js',
                regExp: new RegExp(/^#\/about/)
            },
            {
                name: 'p-services',
                path: '../pages/service.component.js',
                regExp: new RegExp(/^#\/services/)
            },
            // Settings page (URL: /#/settings )
            {
                name: 'p-work',
                path: '../pages/work.component.js',
                regExp: new RegExp(/^#\/work/)
            },
            // Editor page to create/edit articles (URL: /#/editor, /#/editor/article-slug-here )
            {
                name: 'p-contact',
                path: '../pages/contact.component.js',
                regExp: new RegExp(/^#\/contact/)
            },
            ...
            {
                name: 'p-project',
                path: '../pages/project.component.js',
                regExp: new RegExp(/^#\/project/)
            }
        ]
