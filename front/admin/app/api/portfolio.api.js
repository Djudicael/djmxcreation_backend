...
export default class PortfolioApi {
  ...
  async createProject({ title, subTitle, client }) {
    ...
    return await this.instance.doPost({
  ...
  async deleteContent(id, contentID) {
    return await this.instance.doDelete({
  ...
  async addContentToProject(id, { file }) {
    ...
    return await this.instance.doPatchMultipart({
  ...
  async updateAboutMePicture(id, { file }) {
    ...
    return await this.instance.doPostMultipart({
  ...
  async updateProject(projectId, project) {
    ...
    return await this.instance.doPutVoid({
